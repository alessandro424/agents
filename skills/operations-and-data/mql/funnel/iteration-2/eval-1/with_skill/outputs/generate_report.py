...
csv_path = r"c:/Users/aless/AppData/Local/Temp/69ac6d09-63d7-471e-a03d-3afed2d43190_hubspot-custom-report-total-mql-entered-2026-03-26-1.zip.190/total-mql-entered.csv"
output_dir = r"c:/Users/aless/Documents/skills/mql-funnel-workspace/iteration-2/eval-1/with_skill/outputs"
...
class PDF(FPDF):
    ...
    def table_data_row(self, cells, widths, fill_color=None, font_size=9, aligns=None):
        ...
        for i, (cell, w) in enumerate(zip(cells, widths)):
            ...
            self.cell(w, 6, str(cell), border=1, fill=(fill_color is not None), align=align)
        self.ln()
...
for j, rec in enumerate(recs[:7], 1):
    ...
    if len(parts) == 2:
        ...
        pdf.set_font('Helvetica', '', 10)
        pdf.multi_cell(0, 6, f' {parts[1]}')
    else:
        pdf.set_font('Helvetica', '', 10)
        pdf.multi_cell(0, 6, f'{j}. {rec}')
    pdf.ln(2)
